...
signal BattleConditionActivated(battle_condition: BattleCondition, entity: BaseBattlerStats)
signal BattleConditionExpired(battle_condition: BattleCondition, entity: BaseBattlerStats)  # NEW
